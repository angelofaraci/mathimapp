...
### Requirement: Inicio Tab Hosts CourseScreen

The system SHALL render the existing `CourseScreen` as Inicio tab content, preserving its current behavior.

#### Scenario: Inicio displays course content

- GIVEN the user selects the Inicio tab
- WHEN the tab content renders
- THEN the system SHALL display the existing CourseScreen unchanged
